...
validaCNPJ(cnpj) {
  ...
  Valido() {
    ...
    if (this.formCliente.controls.nome.valid && this.formCliente.controls.genero.valid && this.formCliente.controls.dataNascimento.valid
      && this.formCliente.controls.email.valid && this.formCliente.controls.contato1.valid
      && this.formCliente.controls.cpfCnpj.valid && this.formCliente.controls.endereco.valid && this.formCliente.controls.cidade.valid
      && this.formCliente.controls.uf.valid && this.formCliente.controls.senha.valid) {
      this.invalido = false;
    }
    else {
      this.invalido = true;
  ...
  onSubmit() { 
    ...
    if (this.formCliente.controls.nome.valid && this.formCliente.controls.genero.valid && this.formCliente.controls.dataNascimento.valid
      && this.formCliente.controls.email.valid && this.formCliente.controls.contato.valid
      && this.cpfCnpj && this.formCliente.controls.endereco.valid && this.formCliente.controls.cidade.valid
      && this.formCliente.controls.uf.valid && this.formCliente.controls.senha.valid) {
      this.resultado = "SemErro";
      ...
      console.log("nome" + this.formCliente.controls.nome.valid
        + " genero" + this.formCliente.controls.genero.valid +
        " dataNascimento" + this.formCliente.controls.dataNascimento.valid +
        " email" + this.formCliente.controls.email.valid +
        " contato" + this.formCliente.controls.contato.valid +
        " cpf" + this.formCliente.controls.cpfCnpj.valid + 
        " endereco" + this.formCliente.controls.endereco.valid + 
        " cidade" + this.formCliente.controls.cidade.valid +
        " estado" + this.formCliente.controls.uf.valid + 
        " senha" + this.formCliente.controls.senha.valid)
