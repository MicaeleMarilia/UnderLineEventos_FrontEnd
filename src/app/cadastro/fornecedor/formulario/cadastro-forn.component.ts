...
export class FormularioFornecedor implements OnInit {
  ...
  createForm(fornecedor: Fornecedor) {
    this.formFornecedor = this.formBuilder.group({
      ...
      bairro: [fornecedor.bairro, Validators.compose([
        Validators.minLength(3)
      ])],
  ...
  onSubmit() {
    if (this.formFornecedor.controls.nomeFantasia.valid &&
      this.formFornecedor.controls.nomeResponsavel.valid &&
      this.cpfCnpj && this.formFornecedor.controls.uf.valid &&
      this.formFornecedor.controls.cidade.valid &&
      this.formFornecedor.controls.endereco.valid &&
      this.formFornecedor.controls.contato.valid &&
